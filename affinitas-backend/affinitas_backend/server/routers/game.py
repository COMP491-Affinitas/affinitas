...
@limiter.limit("3/minute")
async def _load_game(request: Request, payload: GameLoadRequest, x_client_uuid: XClientUUIDHeader):
...
async def _save_game(request: Request, payload: GameSaveRequest, x_client_uuid: XClientUUIDHeader):
...
@limiter.limit("3/minute")
async def _quit_game(request: Request, payload: GameQuitRequest, x_client_uuid: XClientUUIDHeader):
...
async def _end_game(request: Request, payload: GameEndRequest, x_client_uuid: XClientUUIDHeader):
